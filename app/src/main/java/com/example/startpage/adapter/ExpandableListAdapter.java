package com.example.startpage.adapter;
...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
	...
	private int[] mDrawableList=new int[]{R.mipmap.icon_one, R.mipmap.icon_two,R.mipmap.icon_three,R.mipmap.icon_four,R.mipmap.icon_five,R.mipmap.icon_six,R.mipmap.icon_seven,R.mipmap.icon_eight,R.mipmap.icon_nine};
	...
	public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (isExpanded) {
			...
			Drawable drawableUp = _context.getResources().getDrawable(R.drawable.icon_chevron_down);
...
//			header_text.setCompoundDrawablesWithIntrinsicBounds( R.drawable.a60, 0, R.drawable.ic_up, 0);
			...
			// and change the icon
			Drawable drawableDown = _context.getResources().getDrawable(R.drawable.icon_chevron_right);
